...
import {AppMenuService} from "flusysng/layout/services";
    ...
    <ng-container>
      ...
      @if (item.items) {
        <ul [@children]="submenuAnimation">
          @for (child of item.items; track child.name; let i = $index) {
...
export class AppMenuitemComponent implements OnInit, OnDestroy {
  ...
  constructor(public router: Router, private menuService: AppMenuService) {
